...
Contributors: @voxpow
Tags: speech, speech recognition, voice recognition, voice detection, write with voice, voice commands, voice command, speech to text
...
**Documentation**
You can find additional information about the setup and advanced configuration here: [docs.voxpow.com](https://docs.voxpow.com/)

**Coming soon**
* Statistic about searches in WordPress admin section
...
= 1.1.7 =
* Changes in tracking code snippet to support more field types
